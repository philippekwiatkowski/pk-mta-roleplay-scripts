...
local mapFile                           = ":[ars]mods-system/map/radar.jpg"
...
function drawBlips()
	for k,v in ipairs(getElementsByType("blip")) do
		if not getElementData(v,"DoNotDrawOnMaximap") then
			...
			dxDrawImage(x-halfsize,y-halfsize,size,size,"map/blips/"..icon..".png",0,0,0,tocolor(r,g,b,a),false)
		end
	end
end
...
function drawLocalPlayerArrow()
	...
	dxDrawImage(mapX-8,mapY-8,16,16,"map/blips/2.png",(-r)%360,0,0,normalColor,false)
end
...
function setPlayerMapImage(image,tLX,tLY,lRX,lRY)
	...
	elseif not image then
		...
		mapFile                           = ":[ars]mods-system/map/radar.jpg"
